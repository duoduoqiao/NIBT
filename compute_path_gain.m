function path_gain = compute_path_gain(pay_amount, max_tran, balance_ranges, pay_upper)
...
if pay_amount <= max_tran
    ...
    for i=1:tran_num
        ...
        pay_success_prob(i) = compute_path_success_prob(pay_amount_i, balance_ranges);
